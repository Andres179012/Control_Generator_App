...
// import Toggle from '../components/ToggleDarkMode/TogleDarkMode';
...
export default function NavHeader({username}) {
  return (
    <>
      <div className="md:h-[10vh] sticky top-0 z-50">
                  ...
                  <div className="hidden md:block">
                    <div className="ml-4 flex items-center md:ml-6">
                      ...
                      >
                        ...
                        <BiLogOut className="h-6 w-6" aria-hidden="true" />
                      </button>
                      {/* Profile dropdown */}
                      <Menu as="div" className="ml-3 relative">
                        <div>
                          <Menu.Button className="max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                            ...
                            <UserIcon className='h-8 w-8 rounded-full text-white p-2'/>
              ...
              <Disclosure.Panel className="md:hidden">
                <div className="pt-4 pb-3 border-t border-gray-700">
                  <div className="flex items-center px-5">
                    <div className="flex-shrink-0">
                      <UserIcon className='h-8 w-10 rounded-full text-white p-1'/>
                    </div>
                    <div className="ml-3">
