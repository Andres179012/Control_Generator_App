...
function WriteAccesos() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await addDoc(collection(db, "AccessList"), {
        name: name,
        url: url,
        user: user,
        password: password,
      ...
      <div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="flex flex-wrap justify-center access_List">
            <div className="flex flex-wrap justify-center access_List max-w-7xl">
            ...
            <div className="content-btn-responsive self-center">
              <button
